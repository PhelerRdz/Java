 ...
 * @author jorge
 */
public class P12_AEROLINEA extends javax.swing.JFrame {

    private int BOLETOS;
    private float PRICE;
    private String ESCAL, DEST, ASIENTO, HOR;
    private int VUELO;
    P12_AEROLINEA[] vuelos = new P12_AEROLINEA[10];
    int cont = 0;

    public P12_AEROLINEA(int VUELO, int BOLETOS, float PRICE, String ESCAL, String DEST, String ASIENTO, String HOR) {
        this.VUELO = VUELO;
    ...
    public P12_AEROLINEA(int VUELO) {
        this.VUELO = VUELO;
    }
    ...
    private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton4ActionPerformed
        if (cont != 10) {
            vuelos[cont] = new P12_AEROLINEA((cont + 1), BOLETOS, PRICE, ESCAL, DEST, ASIENTO, HOR);
            cont++;
        } else {
            System.out.println("La Memoria esta llena, se recomienda eliminar ordenes");
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P12_AEROLINEA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new P12_AEROLINEA().setVisible(true);
            }
        });
    }
