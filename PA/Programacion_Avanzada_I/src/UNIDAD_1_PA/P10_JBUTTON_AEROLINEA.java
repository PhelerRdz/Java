 ...
 * @author Pheler
 */
public class P10_JBUTTON_AEROLINEA extends javax.swing.JFrame {

    private int BOLETOS;
    private float PRICE;
    private String ESCAL, DEST, ASIENTO, HOR;
    
    public P10_JBUTTON_AEROLINEA() {
        this.PRICE = 1099.99f;
        this.BOLETOS = 1;
        initComponents();
    ...
    private void Button01ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_Button01ActionPerformed
        int answer;
        String message = "ESCALA: " + this.ESCAL + "\n" +
        "DESTINO: " + this.DEST + "\n" +
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(P10_JBUTTON_AEROLINEA.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new P10_JBUTTON_AEROLINEA().setVisible(true);
            }
        });
    }
