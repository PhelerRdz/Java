 ...
 */
package edd_u5_01_grafoponderado;
 ...
 * @author ZUBIRI
 */
public class EDD_U5_01_GrafoPonderado {
    ...
    public static void main(String[] args) {
       ...
       int n,resp,peso;
        ...
        EDD_U5_01_GrafoPonderado matriz = new EDD_U5_01_GrafoPonderado(n);
        ...
        System.out.println("");
        System.out.println("Representacion del Grafo Ponderado");
        matriz.imprimir();
    }
    ...
    public EDD_U5_01_GrafoPonderado(int n) {
        this.n = n;
