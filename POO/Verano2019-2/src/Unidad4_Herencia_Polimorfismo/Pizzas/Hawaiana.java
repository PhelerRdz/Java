...
public class Hawaiana extends Pizza{
    ...
    public Hawaiana(int numpedido, String numPizza) {
        super(numPizza);
        this.numpedido = numpedido;
    }

    public Hawaiana(int numpedido, int precio, String queso, int rebanadas, String ingrincipal, String numPizza, int Masa, String Nombre, String NomServicio) {
