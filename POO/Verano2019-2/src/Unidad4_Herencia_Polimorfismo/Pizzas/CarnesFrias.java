...
public class CarnesFrias extends Pizza{
    ...
    public CarnesFrias(int numpedido, String numPizza) {
        super(numPizza);
        this.numpedido = numpedido;
    }

    public CarnesFrias(int numpedido, int precio, String queso, int rebanadas, String ingrincipal, String numPizza, int Masa, String Nombre, String NomServicio) {
